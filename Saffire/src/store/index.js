...
const reducer = combineReducers({currentItinerary, burgerMenu, currentEvents, users, currentUser, refresh, connect, searchUser, currentCoordinates, googleDetails, members, locationList })
